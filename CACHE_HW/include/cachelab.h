...
/* Cache profile selected by test-trans for transpose_submit dispatch */
#define TRANS_CACHE_DIRECT 0
#define TRANS_CACHE_2WAY   1
#define TRANS_CACHE_4WAY   2
extern int trans_cache_profile;
